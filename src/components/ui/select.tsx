...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      data-slot={asChild ? undefined : 'select-trigger'}
      asChild={asChild}
      data-size={size}
      className={cn(
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          position === 'popper' &&
            'p-1 data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1',
          className
        )}
        position={position}
        align={align}
